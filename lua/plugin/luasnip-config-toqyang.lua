...
vim.opt.runtimepath = vim.opt.runtimepath + '~/.config/nvim/config/friendly-snippets'
require("luasnip.loaders.from_vscode").load({ include = { "javascript", "javascriptreact" } }) -- Load only python snippets
